...
public class CriaConta {
	...
	public static void main(String[] args) {
		Conta primeiraConta = new Conta();//preciso declarar de qual variável é, conta ref a 1ª conta
		...
		Conta segundaConta = new Conta(); //new Conta() é um endereço de memória q ele guardou e eu quero guardar isso dentro de uma referência q se chama 2ª conta
